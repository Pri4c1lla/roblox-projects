...
extremely messy code. i know it. 😮‍💨
...
run(function()
    ...
    repeat wait() until ReplicatedStorage
...
local Tabs = {
    Debugs = Window:AddTab({ Title = "Debuggers", Icon = "" }),
    ACByp = Window:AddTab({ Title = "Anti Cheats", Icon = "" }),
}

--// debugs first

Tabs.Debugs:AddButton({
...
Tabs.Debugs:AddButton({
    ...
    Callback = function()
        ...
        elseif not IsOnMobile and not executor_used == "Xeno" then
            loadstring(game:HttpGet("https://raw.githubusercontent.com/infyiff/backup/main/dex.lua"))()
		else
            loadstring(game:HttpGet("https://raw.githubusercontent.com/Pri4c1lla/Storage/refs/heads/main/Assets/Dex.lua"))()
		end
    end
})
...
Tabs.Debugs:AddButton({
	Title = "SimpleSpy V3",
	Description = "(detection by adonis or namecall detection)",
	Callback = function()
		if IsOnMobile then
...
Tabs.Debugs:AddButton({
	Title = "Hydroxide",
	Description = "Ultimate remote spy (detection by adonis or namecall detection)",
	Callback = function()
...
InterfaceManager:SetFolder("pri4c1lla/Configs")
SaveManager:SetFolder("pri4c1lla/Configs")
