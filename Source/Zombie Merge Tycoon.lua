...
run(function()
    local success,result = pcall(function()
        ...
        for _,v in pairs(ReplicatedStorage.Weapon:GetChildren()) do
            if v:IsA("Tool") then
...
run(function()
    ...
    local Window = Fluent:CreateWindow({
        Title = "Zombie Merge Tycoon | 10/22/2024",
        SubTitle = "By Shion",
    ...
    RunService.Heartbeat:Connect(function()
        ...
        pcall(function()
            ...
            if Script.Misc.Killzombies then
                for i,v in pairs(workspace.Zombies:GetDescendants()) do -- impossible to use GetChildren. if you use GetDescendants it little bit laging.
